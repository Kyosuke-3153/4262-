...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	int bgm[4];
	bgm[0] = LoadSoundMem("Resource/小さな魔女.mp3");
	ChangeVolumeSoundMem(255 * 20 / 100, bgm[0]);
	bgm[1] = LoadSoundMem("Resource/Hope_Amidst_Youthful_Poverty.mp3");
	ChangeVolumeSoundMem(255 * 20 / 100, bgm[1]);
	bgm[2] = LoadSoundMem("Resource/いたずら３きょうだい.mp3");
	ChangeVolumeSoundMem(255 * 20 / 100, bgm[2]);
	bgm[3] = LoadSoundMem("Resource/b47a1cbcadc45b8c.mp3");
	ChangeVolumeSoundMem(255 * 20 / 100, bgm[2]);
